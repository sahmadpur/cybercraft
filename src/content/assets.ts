...
export const ASSETS = {
  ...
  "vendor-huawei": { src: "/assets/vendors/huawei.webp", alt: "Huawei", width: 512, height: 512 },
  "vendor-apple": { src: "/assets/vendors/apple.webp", alt: "Apple", width: 512, height: 512 },
  "vendor-lenovo": { src: "/assets/vendors/lenovo.webp", alt: "Lenovo", width: 512, height: 512 },
  "vendor-samsung": { src: "/assets/vendors/samsung.webp", alt: "Samsung", width: 512, height: 512 },
  "vendor-hikvision": { src: "/assets/vendors/hikvision.webp", alt: "Hikvision", width: 512, height: 512 },
  "vendor-fudo-security": { src: "/assets/vendors/fudo-security.webp", alt: "Fudo Security", width: 512, height: 512 },
  "vendor-cloudflare": { src: "/assets/vendors/cloudflare.webp", alt: "Cloudflare", width: 512, height: 512 },
  "vendor-palo-alto": { src: "/assets/vendors/palo-alto.webp", alt: "Palo Alto Networks", width: 512, height: 512 },
  "vendor-check-point": { src: "/assets/vendors/check-point.svg", alt: "Check Point", width: 385, height: 184 },
  "vendor-hcl-software": { src: "/assets/vendors/hcl-software.webp", alt: "HCL Software", width: 225, height: 225 },
  "vendor-veeam": { src: "/assets/vendors/veeam.webp", alt: "Veeam", width: 680, height: 680 },
  "vendor-dell": { src: "/assets/vendors/dell.webp", alt: "Dell", width: 512, height: 512 },
  "vendor-microsoft": { src: "/assets/vendors/microsoft.webp", alt: "Microsoft", width: 512, height: 512 },
  "vendor-hp": { src: "/assets/vendors/hp.webp", alt: "HP", width: 512, height: 512 },
  "vendor-ibm": { src: "/assets/vendors/ibm.webp", alt: "IBM", width: 512, height: 512 },
  "vendor-canon": { src: "/assets/vendors/canon.webp", alt: "Canon", width: 512, height: 512 },
  "vendor-fortinet": { src: "/assets/vendors/fortinet.webp", alt: "Fortinet", width: 512, height: 512 },
  "vendor-cisco": { src: "/assets/vendors/cisco.webp", alt: "Cisco", width: 512, height: 512 },
  "vendor-f5": { src: "/assets/vendors/f5.webp", alt: "F5", width: 512, height: 512 },
  "vendor-xfusion": { src: "/assets/vendors/xfusion.webp", alt: "xFusion", width: 225, height: 225 },
  "vendor-xfusion-wide": { src: "/assets/vendors/xfusion-wide.webp", alt: "xFusion", width: 2560, height: 328 },
  "vendor-tenable": { src: "/assets/vendors/tenable.webp", alt: "Tenable", width: 800, height: 500 },
  "vendor-datadog": { src: "/assets/vendors/datadog.webp", alt: "Datadog", width: 400, height: 400 },
  "vendor-checkpro": { src: "/assets/vendors/checkpro.webp", alt: "CheckPro", width: 512, height: 512 },

  // Partners (order matches the live /partners/ page)
  "partner-gulfstream": { src: "/assets/partners/gulfstream.webp", alt: "Gulfstream Distribution", width: 512, height: 512 },
  "partner-softprom": { src: "/assets/partners/softprom.webp", alt: "Softprom", width: 512, height: 512 },
  "partner-muk": { src: "/assets/partners/muk.webp", alt: "MUK", width: 337, height: 137 },
  "partner-techpro-dc": { src: "/assets/partners/techpro-dc.webp", alt: "Techpro DC", width: 512, height: 512 },
  "partner-techpro-dc-wide": { src: "/assets/partners/techpro-dc-wide.webp", alt: "Techpro DC", width: 512, height: 512 },
  "partner-bakotech": { src: "/assets/partners/bakotech.webp", alt: "BAKOTECH", width: 512, height: 512 },
  "partner-elcore": { src: "/assets/partners/elcore.webp", alt: "Elcore", width: 200, height: 200 },
  "partner-erc": { src: "/assets/partners/erc.webp", alt: "ERC", width: 225, height: 225 },
  "partner-estet": { src: "/assets/partners/estet.webp", alt: "ESTET", width: 1013, height: 720 },
  "partner-mont-azerbaijan": { src: "/assets/partners/mont-azerbaijan.webp", alt: "Mont Azerbaijan", width: 512, height: 512 },
